...
struct StoryBrain {
    ...
    func getTitle() -> String {
        return self.stories[self.storyNumber].title
    }
    
    func getChoices() -> (choice1: String, choice2: String) {
        return (choice1: self.stories[self.storyNumber].choice1,
                choice2: self.stories[self.storyNumber].choice2)
    }
